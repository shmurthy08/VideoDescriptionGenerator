'''
This code is provided to demonstrate how to use Keras Tuner to tune hyperparameters for the VideoCaptioningModel.
This code is not vital to understand the conv_transformer.py file. 
If you require use of this file please append it to the conv_transformer.py file.
'''
